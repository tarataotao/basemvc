...
<script type="application/javascript">
    $(function(){
      ...
      /*      var ctx='${pageContext.request.contextPath}'; //el表达式
            alert(ctx);*/
            $.ajax({
                url:"<%=request.getContextPath()%>/sys/dept/tree.json",
        ...
        function loadUserList(deptId){
            ...
            var pageNo=$("#userPage .pageNo").val();
            $.ajax({
                url:url,
                data:{
                    pageSize:pageSize,
                        ...
                        "bold":function(){
                            return function(text,render){
                                ...
                                if(status=='有效'){
                                    ...
                                    return "<span class='label label-sm'>无效</span>";
                                }
                            }
                        }
                    });
        ...
        function updateUser(isCreate,successCallback,failCallback){
            $.ajax({
                url:isCreate?"<%=request.getContextPath()%>/sys/user/save.json":"<%=request.getContextPath()%>/sys/user/update.json",
        ...
        function updateDept(isCreate,successCallback,failCallback){
            $.ajax({
                url:isCreate?"<%=request.getContextPath()%>/sys/dept/save.json":"<%=request.getContextPath()%>/sys/dept/update.json",
