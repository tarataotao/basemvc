            ...
            <ul class="nav ace-nav">
                <li class="light-blue dropdown-modal">
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="${pageContext.request.contextPath}/logout.page"> <i class="ace-icon fa fa-power-off"></i>
                                注销
                            </a>
                        </li>
                    </ul>
...
<div class="main-container" id="main-container">
    ...
    <div class="main-content">
        <iframe id="innerFrame" src="${pageContext.request.contextPath}/sys/dept/dept.page" width="99%" style="min-height: 768px;"></iframe>
    </div>
    <!-- /.main-content -->
